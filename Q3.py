...
def mostrar_q3(screen):
    ...
    alt_textos = ["escolha", "palavra certa", "certa", "errada"]
    botoes = []
    btn_w, btn_h = 300, 60
    espaco_x = 40
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if botoes[0].rect.collidepoint(event.pos):  # Alternativa correta: 'escolha'
                    import Q4
                    Q4.mostrar_q4(screen)
                    return
        ...
        screen.fill(CINZA)
        questoes(3, screen, largura, roxo_claro, roxo_escuro)
